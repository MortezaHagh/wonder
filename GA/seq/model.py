...
class Model:
    def __init__(self) -> None:
        ...
        self.zones_b.append(Zone(3, 35, 1, 39, 1, 37, 1, 2))
        self.zones_b.append(Zone(4, 44, 1, 48, 1, 46, 1, 2))
        self.zones_b.append(Zone(5, 25, 20, 35, 20, 30, 20, 5))
        self.zones_b.append(Zone(6, 55, 5, 55, 9, 55, 7, 2))
        ...
        k = 2*self.n_zones
        self.dss = []
        self.dss.append(DS(k, 12, 10))
        self.dss.append(DS(k+1, 32, 10))
        self.dss.append(DS(k+2, 44, 10))
